...
def presToRenderScript(pres, layerName, **ns):
    ...
    try:
        ...
        doc = libxml2.parseDoc(psppres)
        result = _presXslt.applyStylesheet(doc, {
            'LAYER': repr(layerName) })
...
_presXml = libxml2.parseDoc(_presStylesheet)
_presXslt = libxslt.parseStylesheetDoc(_presXml)
