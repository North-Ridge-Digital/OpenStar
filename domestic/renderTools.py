...
def createTitleBar(string1, string2, s1BkgColor, s2BkgColor, s1TxtColor, s2TxtColor, s1ShdColor, s2ShdColor):
    ...
    (r, g, b, a) = rgbaConvert(212, 212, 212, int(255 * 0.80000000000000004))
    V3 = (0, 0, r, g, b, a)
    ...
    if string1:
        ...
        if string2:
            ...
            (r, g, b, a) = rgbaConvert(R, G, B, A * 0.029999999999999999)
            V3 = (bg1X + 520, bg1Y, r, g, b, a)
            V7 = (bg1X, bg1Y + 72, r, g, b, a)
            (r, g, b, a) = rgbaConvert(R, G, B, A * 0.025000000000000001)
    ...
    if string2:
        ...
        (r, g, b, a) = rgbaConvert(R, G, B, A * 0.54000000000000004)
        V2 = (bg2X + 425, bg2Y, r, g, b, a)
        V4 = (bg2X, bg2Y + 46, r, g, b, a)
        (r, g, b, a) = rgbaConvert(R, G, B, A * 0.32000000000000001)
...
def drawValidTimeSlider(page, lastImageDuration, imageDuration, imageCount, timeScale, timeScaleOffset, loopLimit):
    ...
    pp = Polygon()
    pp.addVertex(xPos, yPos, r, g, b, a * 0.20000000000000001)
    pp.addVertex(xPos + 20, yPos, r, g, b, a * 0.80000000000000004)
    pp.addVertex(xPos + 50, yPos, r, g, b, a)
    pp.addVertex(xPos + 56, yPos + 21, r, g, b, a)
    pp.addVertex(xPos + 20, yPos + 21, r, g, b, a * 0.80000000000000004)
    pp.addVertex(xPos, yPos + 21, r, g, b, a * 0.20000000000000001)
    slider.addItem(pp)
    page.addItem(slider)
    ...
    legendStartPos = 306
    f = TTFont('/rsrc/fonts/Interstate-BlackItalic', 20, shadow = 0)
