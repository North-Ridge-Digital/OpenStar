...
def getValidFileList(dataPath = './', prefix = None, suffix = None, startTimeNdx = None, endTimeNdx = None, sortIndex = None, sep = '.'):
    ...
    for filename in imageList:
        ...
        if endTimeNdx is not None:
            ...
            try:
                endTime = long(fileParts[endTimeNdx])
                if now >= endTime:
                    continue
            except:
                continue
        ...
        if startTimeNdx is not None:
            ...
            try:
                startTime = long(fileParts[startTimeNdx])
                if now < startTime:
                    continue
            except:
                continue
        ...
        if sortIndex:
            ...
            try:
                returnList.append((long(fileParts[sortIndex]), filename))
            except:
                continue
...
def getValidImageList(dataPath, productString, ignoreExpiration = 0):
    '''DEPRECATED: Return a list of valid image files sorted by issue time.
    ...
    for filename in imageList:
        ...
        try:
            issueTime = long(fileParts[3])
            expirationTime = long(fileParts[4])
        except:
            issueTime = 1
            expirationTime = 1
...
def formatSevereWxQualifier(severeWxQualCode):
    severeWxQualifier = {
        'Q9005': 'Potential for up to 3 inches of snow',
        'Q9010': 'Potential for up to 6 inches of snow',
        'Q9015': 'Potential for 6-12 inches of snow',
        'Q9020': 'Potential for a foot or more of snow',
        'Q9025': 'Potential for significant snowfall',
        'Q9030': 'Potential for blizzard conditions',
        'Q9205': 'Potential for some icing',
        'Q9210': 'Potential for significant icing',
        'Q9350': 'Strong Santa Ana winds possible',
        'Q9405': 'Potential for heavy rainfall',
        'Q9410': 'Potential for flooding rains',
        'Q9605': 'Potential for severe thunderstorms',
        'Q9610': 'Severe thunderstorms expected',
        'Q9800': 'Watching the tropics',
        'Q9805': 'Tropical storm conditions possible',
        'Q9810': 'Tropical storm conditions likely',
        'Q9815': 'Hurricane conditions possible',
        'Q9820': 'Hurricane conditions likely',
        'Q9825': 'Major hurricane conditions possible',
        'Q9830': 'Major hurricane conditions likely' }
...
def formatSnowAccum(snowAccumCode):
    snowAccum = {
        'A9005': 'up to 3 inches of snow',
        'A9010': 'up to 6 inches of snow',
        'A9015': '6-12 inches of snow',
        'A9020': 'a foot or more of snow',
        'A9025': 'a significant snowfall',
        'A9205': 'some icing',
        'A9210': 'significant icing' }
